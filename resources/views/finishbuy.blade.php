    ...
    <div class="col-12 col-lg-6">
        ...
        <p>adreseniz:</p>
            ...
            <div class="d-flex flex-row align-items-center ">
                <dıv for="id{{ $address->id }}" class="m-3 p-3 flex-fill" style="border-radius: 10px;border: 2px solid blue">
                    {{ $address->province }} &nbsp;&nbsp;
                    {{ $address->city }} &nbsp;&nbsp;
                    {{ $address->adress }} &nbsp;&nbsp;
                    {{ $address->zipcode }} &nbsp;&nbsp;
            ...
            @endforeach
        <a class="btn btn-success m-3" href="{{ route('finishbuyget') }}">Onayla</a>
        @endif
    </div>
</div>
