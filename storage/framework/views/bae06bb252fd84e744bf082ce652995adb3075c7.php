...
<head>
    ...
    <!-- site metas -->
    <title><?php echo e(env('APP_NAME')); ?> | sepet
    </title>
...
<div class="d-flex flex-wrap box_main " style="min-height:80vh; margin:150px 10px">
    <?php if(count($products) > 0): ?>
        <table class="table table-hover  ">
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('seemore',$product->id)); ?>">
                            
                            <img width="60" src="<?php echo e('storage/imgProductTemp/'.$images[0]); ?>" alt="">
                            <span><?php echo e($product->price); ?> TL</span>
                            
                        </a>
                    </td>
                    <td>
                        <a href="<?php echo e(route('deletefromcart',$product->id)); ?>">
            ...
            <?php if(count($products) > 0): ?>
                <tr>
                    ...
                    <th class="spann"><?php echo e($prices); ?> TL</th>
                    <th class="spann"></th>
                </tr>
            <?php else: ?>
        ...
        <dıv class="blockdir">
            <div class="m-3">
                <a class="btn btn-success d-block" href="<?php echo e(route('acceptbuy')); ?>">Sepeti Onayla</a>
            </div>
            <?php if(!auth()->user()): ?>
                <div class="m-3">
...
<div class='note fixed-top alert alert-<?php echo e($color); ?>'><?php echo e($status); ?> </div>
<?php else: ?>
    </script>
<?php endif; ?>
...
<?php /**PATH D:\my\my project\laravel\p3\myProject\resources\views/shoppingcart.blade.php ENDPATH**/ ?>