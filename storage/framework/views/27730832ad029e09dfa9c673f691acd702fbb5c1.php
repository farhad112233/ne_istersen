...
<head>
    ...
    <!-- site metas -->
    <title><?php echo e(env('APP_NAME')); ?> | onayla
    </title>
...
<div class="d-flex flex-wrap box_main" style="min-height:80vh;margin:150px 10px; ">
    ...
    <div class="col-12 col-lg-6">
        ...
        <?php if(gettype($addresses)==='object'): ?>
            <p>adreseniz:</p>
            <form action="<?php echo e(route('finishbuy')); ?>" method="post" class="d-flex flex-column">
                <?php echo csrf_field(); ?>
                <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex flex-row align-items-center ">
                        <input id="id<?php echo e($address->id); ?>" type="radio" name="successadress"
                               value="<?php echo e($address->id); ?>" <?php echo e($loop->index == 0?"checked" : ""); ?>>
                        <label for="id<?php echo e($address->id); ?>" class="m-3 p-3 flex-fill" style="border-radius: 10px;border: 2px solid blue">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <a class="btn btn-danger m-3" href="<?php echo e(route('addaddress')); ?>">yeni bir adres ekle</a>
        ...
        <?php else: ?>
            <div class="font-weight-bold text-danger fontt">
                ...
                <a class="btn btn-success" href="<?php echo e(route('addaddress')); ?>">yeni bir adres ekle</a>
            </div>
...
<?php /**PATH D:\my\my project\laravel\p3\myProject\resources\views/accept.blade.php ENDPATH**/ ?>